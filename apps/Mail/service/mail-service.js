...
var gMails = [
    ...
    { id: utilsService.makeId(), type: 'income', address: 'itay', subject: 'Welcome to Slack', body: 'Welcome to Slack!\n We\'re happy you\'re here.When you created Front Onboarding,\n we didn\'t ask you to set a password. It\'s time to do that now. If you don\'t set a password within two days,\n we\'ll automatically log you out.', isStarred: false, isRead: false, sentAt: 1551133930594 },
    ...
    { id: utilsService.makeId(), type: 'income', address: 'Matan', subject: 'We are on fireee', body: 'Pick up!', isStarred: false, isRead: false, sentAt: 1551133930594 },
    ...
    { id: utilsService.makeId(), type: 'income', address: 'Idan', subject: 'lets do it!', body: 'Pick up!', isStarred: false, isRead: false, sentAt: 1551133930594 },
    { id: utilsService.makeId(), type: 'income', address: 'Hilla', subject: 'Wassap?', body: 'Pick up!', isStarred: false, isRead: false, sentAt: 1551133930594 },
    { id: utilsService.makeId(), type: 'income', address: 'Hilla', subject: 'Wassap?', body: 'Pick up!', isStarred: false, isRead: false, sentAt: 1551133930594 },
    { id: utilsService.makeId(), type: 'income', address: 'Hilla', subject: 'Wassap?', body: 'Pick up!', isStarred: false, isRead: false, sentAt: 1551133930594 },
    { id: utilsService.makeId(), type: 'income', address: 'Hilla', subject: 'Wassap?', body: 'Pick up!', isStarred: false, isRead: false, sentAt: 1551133930594 },
    ...
    { id: utilsService.makeId(), type: 'draft', address: 'Hilla@gmail.com', subject: 'Wassap?', isStarred: false, body: 'I stater to write a letter but didnwt found the', isRead: true, sentAt: 1551133930594 },
    { id: utilsService.makeId(), type: 'draft', address: 'Hilla@gmail.com', subject: 'Wassap?', isStarred: false, body: 'I stater to write a letter but didnwt found the', isRead: true, sentAt: 1551133930594 },
    { id: utilsService.makeId(), type: 'draft', address: 'Hilla@gmail.com', subject: 'Try', isStarred: false, body: 'I stater to write a letter but didnwt found the', isRead: true, sentAt: 1551133930594 }
]
