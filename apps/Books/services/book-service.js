...
function getEmptyReview() {
    const review = { id: makeId(), fullName: '', rating: 1, datepicker: '', txt: '' };
    return review;
}
...
function getNextPrev(bookId) {
   return query()
        .then(books => {
            ...
            const nextBook = gBooks[bookIdx + 1] || gBooks[0]
            const prevBook = gBooks[bookIdx - 1] || gBooks[gBooks.length - 1]
            return {
...
function getBoooksFromApi(name) {
